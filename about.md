...
- As I started my professional career by building Germany's first major Internet search engine [FIREBALL](https://de.wikipedia.org/wiki/Fireball_(Suchmaschine)) (see [Patent](https://www.researchgate.net/publication/295980243_Hypertext_documents_evaluation_method_using_search_engine_involves_calculating_real_relevance_value_for_each_document_based_on_precalculated_relevance_value_and_cross_references_of_document)) I could not prevent myself from integrating a simple but speedy **[search engine](/search)**. You can find articles by searching in the full text of all posts - enter any keyword or phrase of interest.
